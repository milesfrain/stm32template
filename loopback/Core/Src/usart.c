...
void MX_UART9_Init(void)
{
  ...
  */
  ...
  /* UART9_RX Init */
  LL_DMA_SetChannelSelection(DMA2, LL_DMA_STREAM_7, LL_DMA_CHANNEL_0);

  LL_DMA_SetDataTransferDirection(DMA2, LL_DMA_STREAM_7, LL_DMA_DIRECTION_PERIPH_TO_MEMORY);
